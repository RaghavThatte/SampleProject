...
public class SampleTest {
	...
	public void invalidAccountNumberTest() {
		System.out.println(ameliaPond + " " + roseTyler + " " + acmeCorp + " " + hackerRank );
		...
		System.out.println("amel >> " + bank.getBalance(ameliaPond));
		assertEquals(bank.getBalance(ameliaPond), 0.0, 0);
		
		System.out.println("rose >> " + bank.getBalance(roseTyler));
